...
| sysroot/     | ❌       | See below.                                                                                                         |
| buildroot/   | ❌       | See below.                                                                                                         |
Lint files are as follows. This may be subject to change.
- `.yamllint.toml`
- `black.toml`
- `pyrightconfig.toml`
