...
def _br() -> Path:
    """Return the buildroot directory under the test's CWD .nanvix/."""
    return _buildroot()
...
class TestBuildrootCreate(unittest.TestCase):
    ...
    def test_creates_lib_dir(self) -> None:
        Buildroot.create()
        self.assertTrue((_br() / "lib").is_dir())

    def test_creates_include_dir(self) -> None:
        Buildroot.create()
        self.assertTrue((_br() / "include").is_dir())

    def test_path_is_absolute(self) -> None:
        Buildroot.create()
        self.assertTrue(_br().is_absolute())
...
class TestBuildrootInstallDep(unittest.TestCase):
    ...
    def test_install_dep_extracts_lib(self) -> None:
        ...
        self.assertTrue((_br() / "lib" / "libz.a").exists())
    ...
    def test_install_dep_extracts_header(self) -> None:
        ...
        self.assertTrue((_br() / "include" / "zlib.h").exists())
    ...
    def test_install_dep_selective_libs(self) -> None:
        ...
        self.assertTrue((_br() / "lib" / "libz.a").exists())
        self.assertFalse((_br() / "lib" / "libextra.a").exists())
    ...
    def test_install_dep_selective_headers(self) -> None:
        ...
        self.assertTrue((_br() / "include" / "zlib.h").exists())
        self.assertFalse((_br() / "include" / "internal.h").exists())
    ...
    def test_install_dep_preserves_header_subdirectory(self) -> None:
        ...
        self.assertTrue((_br() / "include" / "openssl" / "ssl.h").exists())
        self.assertTrue((_br() / "include" / "openssl" / "crypto.h").exists())
        self.assertTrue((_br() / "lib" / "libssl.a").exists())
        # Verify headers are NOT flattened to include/ssl.h
        self.assertFalse((_br() / "include" / "ssl.h").exists())
    ...
    def test_install_dep_preserves_lib_subdirectory(self) -> None:
        ...
        self.assertTrue((_br() / "lib" / "engines" / "libcapi.a").exists())
        self.assertTrue((_br() / "lib" / "libssl.a").exists())
...
class TestBuildrootInstallDepZip(unittest.TestCase):
    ...
    def test_install_dep_zip_extracts_lib(self) -> None:
        ...
        self.assertTrue((_br() / "lib" / "libz.a").exists())
        self.assertEqual((_br() / "lib" / "libz.a").read_bytes(), b"lib-content")
    ...
    def test_install_dep_zip_extracts_header(self) -> None:
        ...
        self.assertTrue((_br() / "include" / "zlib.h").exists())
        self.assertEqual((_br() / "include" / "zlib.h").read_bytes(), b"header-content")
